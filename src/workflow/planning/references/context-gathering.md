...
**Load when:** `/workflow:plan` after mode detection, before drafting the implementation plan.
...
**`/workflow:refine`**. Plan **re-verifies** and fills gaps; it does not invent a second product
truth.
