...
Break work into a flat list of required tasks. The shape of that list depends on decomposition mode (see @workflow). All tasks derived from acceptance criteria are required — there are no optional tiers.
