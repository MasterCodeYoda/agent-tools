...
Plans and requirements are **working hypotheses** (@workflow
...
If continue is not driving this session: document and run `/workflow:plan` or
`/workflow:refine` as the event implies, then resume execute.
