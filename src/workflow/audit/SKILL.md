...
Each domain's agents, skill references, tiered analysis, and check criteria are defined in the @workflow audit skill under `domains/`. The orchestrator reads these definitions to know what to dispatch.
...
[If prior audit sessions exist for this project in ~/.claude/history.jsonl — see @workflow references/conversation-analysis.md]
