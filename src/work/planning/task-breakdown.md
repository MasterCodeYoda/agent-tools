...
Break work into a flat list of required tasks. The shape of that list depends on decomposition mode (see @work). All tasks derived from acceptance criteria are required — there are no optional tiers.
...
- [ ] [Mode-appropriate test per @work (`execution/quality-checkpoints.md`)]
