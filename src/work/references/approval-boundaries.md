...
- `/work:continue` on a **named claimable** unit when soft-checks do not force prior remediations  
...
4. Failures of memory become **dated rules** via `/work:compound` (see compound dated-rule
