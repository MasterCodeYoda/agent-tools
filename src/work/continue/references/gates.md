...
**Also load (integrate / automation / claim-class ship):** @work
...
review. **Depth** may scale by track (`quick` | `standard` | `deep` — @work
...
1. A real review pass ran: `/work:review` (preferred), `/code-review`, or structured
...
```text
review: findings-fixed | 2026-07-09 | method=work-review | P1=0 P2=2 P3=1 | disposition=all fixed in <sha>
```
...
- Plan approval (`/work:plan`) — **approval prompt only; no end-of-loop recap**
...
- **method:** /work:review (or structured-agents: <lenses>)
