"""CLI for the workflow process test harness.
    ...
    python -m tests.workflow.harness generate <scenario>
    python -m tests.workflow.harness analyze <run-dir>
    python -m tests.workflow.harness list
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m tests.workflow.harness",
    ...
    g.add_argument("scenario", help="Name under tests/workflow/scenarios/.")
