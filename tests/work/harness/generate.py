...
agent handoff. The middle step (agent runs context-compact / work skills)
is not automated.
"""
...
3. Confirm work skills are current (`./setup.sh` in agent-tools if needed).
...
python -m tests.work.harness analyze "{run_dir}"
```
