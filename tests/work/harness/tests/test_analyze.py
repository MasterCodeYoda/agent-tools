...
from tests.work.harness.analyze import analyze, check_invariant, write_analysis
from tests.work.harness.generate import generate
from tests.work.harness.scenario import load_scenario
...
def test_load_scenario_context_compact_soft():
    ...
    sc = load_scenario(
        root / "tests/work/scenarios/context-compact-soft/scenario.yml"
    )
