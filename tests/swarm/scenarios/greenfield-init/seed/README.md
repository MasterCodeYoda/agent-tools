...
This scenario ships **no charter** — the run begins with `/work:setup`, which detects the
...
exercising `/work:setup` and a clean orchestrator run, not the conflict/integration paths
