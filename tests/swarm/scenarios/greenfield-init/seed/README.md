...
This scenario ships **no charter** — the run begins with `/workflow:setup`, which detects the
...
exercising `/workflow:setup` and a clean orchestrator run, not the conflict/integration paths
