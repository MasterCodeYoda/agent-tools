...
from setup), auto-handoff into multi-item parallel orchestration. Stops only where your
input is genuinely required (plan approval, review triage, merge, path not established).
