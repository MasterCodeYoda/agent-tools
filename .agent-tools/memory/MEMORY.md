...
- [Thin routing / skill-shape](entries/thin-routing-skill-shape.md) — thin SKILL.md control plane; catalogs/templates modular; doc_lint shape rules + shape allowlist
