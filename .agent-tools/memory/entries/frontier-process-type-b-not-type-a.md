---
name: frontier-process-type-b-not-type-a
description: Process skills stay Type B (gates, artifacts, progressive disclosure); Type A shouting and always-on bulk are dead weight under frontier models — prune, don't greenfield-wipe
type: process
...
# Frontier process: Type B keep, Type A prune

## Lesson

Public “skills are dead weight / delete and start over” advice often targets **Type A**
behavior mega-prompts (persistence cheerleading, MUST/NEVER theater, step scripts for weak
models). Our corpus is **Type B** process harness (state machines, evidence gates, on-demand
research, progressive disclosure). Comparing the two is apples/oranges.

**Do not greenfield-wipe.** Aggressively **decontaminate and thin**:
